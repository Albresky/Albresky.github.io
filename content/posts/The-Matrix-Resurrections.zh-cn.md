...
- name: "featured-image-preview"
  src: "featured-image-preview2.webp"
tags: []
categories: []
...
Demo - **黑客帝国4：矩阵重生** 预告
<!--more-->
{{< admonition type=info title="**黑客帝国**简介" open=true >}}
# 黑客帝国 The Matrix (1999) 
{{< image src="/matrix1.jpg" caption="黑客帝国 The Matrix (`image`)" >}}
...
{{< image src="/images/post-The-Matrix-Resurrections/matrix2.jpg" caption="黑客帝国2：重装上阵 The Matrix Reloaded (`image`)" >}}
...
{{< image src="/post-The-Matrix-Resurrections/matrix3.jpg" caption="黑客帝国3：矩阵革命 The Matrix Revolutions (`image`)" >}}
